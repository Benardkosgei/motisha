...
export function EditNewsletterClient({ newsletter }: { newsletter: NewsletterData }) {
  ...
  async function handleDelete() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errData.error || 'Failed to delete newsletter');
      }
      router.push('/admin/newsletters');
    } catch (err) {
      setDeleteError(err instanceof Error ? err.message : 'Failed to delete newsletter');
      setDeleting(false);
  ...
  return (
    <div>
      ...
      >
        <NewsletterForm initialData={newsletter} onSuccess={handleSuccess} mode="edit" />
      </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <strong style={{ color: C.white }}>&ldquo;{newsletter.title}&rdquo;</strong>? The
              attached file will also be removed. This action cannot be undone.
            </p>
