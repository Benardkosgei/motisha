...
import { ArticleForm, type ArticleData } from '@/components/admin/ArticleForm';

export function EditArticleClient({ article }: { article: ArticleData }) {
  ...
  return (
    <div>
      ...
      >
        <ArticleForm initialData={article} onSuccess={handleSuccess} mode="edit" />
      </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <strong style={{ color: C.white }}>&ldquo;{article.title}&rdquo;</strong>? This
