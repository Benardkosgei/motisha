-- Update the notification trigger to handle INSERT and UPDATE, and change notification format
...
-- The trigger is already created in the previous migration, so this will update it